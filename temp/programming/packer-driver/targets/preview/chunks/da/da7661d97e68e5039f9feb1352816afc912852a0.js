      ...
      _export("resourceLoader", resourceLoader = (_dec = ccclass("resourceLoader"), _dec2 = property({
        ...
        constructor() {
          ...
          this.addGlow = (result, pos) => {
            ...
            this.ImageSlide.addChild(this.glowInstantiate); // this.glowInstantiate.setPosition(0, pos.y, 0);
...
//# sourceMappingURL=da7661d97e68e5039f9feb1352816afc912852a0.js.map