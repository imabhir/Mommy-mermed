  ...
  return {
    ...
    execute: function () {
      ...
      _export("resourceLoader", resourceLoader = (_dec = ccclass("resourceLoader"), _dec2 = property({
        ...
        type: Prefab
      }), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class resourceLoader extends Component {
        constructor() {
          super(...arguments);
        ...
        handleStartButtonClick() {
          ...
          var btn = this.child.getChildByName('Button');
          btn.active = false;
          var load = instantiate(this.loading);
...
//# sourceMappingURL=3a05d9865394211446063ffde6a698b0f4127d59.js.map