System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ImageAsset, Prefab, instantiate, CCInteger, UITransform, Vec3, photoSlice2, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, GamePlay;
    ...
    execute: function () {
      ...
      _export("GamePlay", GamePlay = (_dec = ccclass('GamePlay'), _dec2 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "imageAssert", _descriptor, this);

          _initializerDefineProperty(this, "slicePrefab", _descriptor2, this);

          _initializerDefineProperty(this, "imageGlow", _descriptor3, this);

          _initializerDefineProperty(this, "spilt", _descriptor4, this);

          _initializerDefineProperty(this, "sliceNumber", _descriptor5, this);
        ...
        setImageforSlice(imageAsset, inc, callback) {
          ...
          var frameCh = frame.getChildByName('frameChild');
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "imageAssert", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "slicePrefab", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "imageGlow", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "spilt", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "sliceNumber", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=6cdaddad5c4bf89707de96d1a93e6be4ca0d8714.js.map