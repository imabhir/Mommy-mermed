      ...
      _export("GamePlay", GamePlay = (_dec = ccclass('GamePlay'), _dec2 = property({
        ...
        constructor() {
          ...
          this.imageComplete = (result, pos) => {
            ...
            this.imgCallback(this.puzzleResult, pos, this.spilt);
          };
        }
        ...
        setImageforSlice(imageAsset, countsucces, spilt, callback) {
          this.spilt = spilt;
...
//# sourceMappingURL=1656041dd4218a1a2bfb8fc7835b398484789a64.js.map