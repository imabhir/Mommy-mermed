System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, SpriteFrame, math, Sprite, UITransform, Vec3, tween, AudioSource, _dec, _class, _crd, ccclass, property, photoSlice2;
    ...
    execute: function () {
      ...
      _export("photoSlice2", photoSlice2 = (_dec = ccclass('photoSlice2'), _dec(_class = class photoSlice2 extends Component {
        ...
        setSlice(splitCount, Index, imageAsset, callback) {
          ...
          this.NegativePoint = imageAsset.height / 2 - imageAsset.height / this.GnumOfSlice - (this.GnumOfSlice - 1) * (2 + imageAsset.height / this.GnumOfSlice); // console.log(this.imageSprite.height,this.imageSprite.height/this.GnumOfSlice);
        ...
        checkOrder2(event) {
          ...
          for (var i = 0; i < this.GnumOfSlice; i++) {
            ...
            if (nodeName != i) {
              ...
              var lowerDistance = Vec3.distance(AnotherNode.getPosition(), Nodepos); // if(collide ){
...
//# sourceMappingURL=17be2c2537e5734f2e774ca99db54c335986dc2d.js.map