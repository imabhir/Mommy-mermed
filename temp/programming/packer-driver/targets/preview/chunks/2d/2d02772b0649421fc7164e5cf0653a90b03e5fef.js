        ...
        constructor() {
          ...
          this.resetImage = () => {
            ...
            this.ImageSlide.getComponent(_crd && GamePlay === void 0 ? (_reportPossibleCrUseOfGamePlay({
              error: Error()
            }), GamePlay) : GamePlay).setImageforSlice(this.imageArray[this.inc], this.countsuccess, this.spilt, this.addGlow);
          };
          ...
          this.addGlow = (result, pos, spilt) => {
            ...
            if (this.countsuccess == 4) this.countsuccess = 0;
...
//# sourceMappingURL=2d02772b0649421fc7164e5cf0653a90b03e5fef.js.map