    ...
    execute: function () {
      ...
      _export("resourceLoader", resourceLoader = (_dec = ccclass("resourceLoader"), _dec2 = property({
        ...
        initAudioSource() {
          ...
          (_crd && SoundManager === void 0 ? (_reportPossibleCrUseOfSoundManager({
            error: Error()
          }), SoundManager) : SoundManager).getInstance().initSoundEffectAS(this.winSound.getComponent(AudioSource));
        }
...
//# sourceMappingURL=d1411ab8b0714c151e7a5baaf5821b10b46a8071.js.map