    ...
    execute: function () {
      ...
      _export("photoSlice2", photoSlice2 = (_dec = ccclass('photoSlice2'), _dec(_class = class photoSlice2 extends Component {
        ...
        setSlice(splitCount, Index, imageAsset, callback) {
          ...
          console.log(sprite); // this.NegativePoint=(imageAsset.height/2)-(imageAsset.height/this.GnumOfSlice)-(this.GnumOfSlice-1)*((imageAsset.height/this.GnumOfSlice))+((imageAsset.height/this.GnumOfSlice)/2);
...
//# sourceMappingURL=3153b7ee0b82acbbe3e1179cb99c1ce9e652c437.js.map